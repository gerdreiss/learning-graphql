...
object api4:
  ...
  def resolver(dbService: DBService): Query =
    ...
    def getCustomer(id: CustomerId): ZQ[Customer]        = ZQuery.fromRequest(GetCustomer(id))(CustomerDataSource)
    ...
    def getProduct(id: ProductId): ZQ[Product]         = ZQuery.fromRequest(GetProduct(id))(ProductDataSource)
    ...
    def getBrand(id: BrandId): ZQ[Brand]           = ZQuery.fromRequest(GetBrand(id))(BrandDataSource)
